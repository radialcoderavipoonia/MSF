        ...
        <div className="flex lg:flex-row flex-col gap-16">
          <div className="lg:w-[22%]">
            ...
            <div className="pt-12 flex lg:justify-start justify-center gap-4">
              <button className="flex justify-center items-center w-[48px] h-[48px] hover:bg-primary-blue hover_arrow hover:border-transparent transition-all duration-300 cursor-pointer border-[1px] border-primary-blue">
                <SliderArrow />
              </button>
              <button className="flex justify-center items-center rotate-[180deg] w-[48px] h-[48px] hover:bg-primary-blue hover_arrow hover:border-transparent cursor-pointer transition-all duration-300 border-[1px] border-primary-blue">
                <SliderArrow />
              </button>
            </div>
          </div>
