...
const CustomTransparentButton = (props) => {
  ...
  return (
    <button
      aria-label={content}
      className={`bg-transparent font-georgia hover:bg-primary-orange border-transparent border-primary-orange border-[1px] px-5 py-3 font-bold text-base text-primary-orange leading-normal hover:text-white transition-all duration-300 ease-in-out `}
    >
